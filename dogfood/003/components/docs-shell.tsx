...
export function DocsTop(){return <div className="docs-top"><div className="docs-top-inner"><Brand/><div className="docs-search"><Search size={14} style={{marginRight:8}}/>Search documentation, commands, concepts…</div><Link className="btn" style={{height:36}} href="/">Back to Flowbit</Link></div><nav className="docs-mobile-nav" aria-label="Mobile documentation"><Link href="/docs" className="active">Overview</Link><Link href="/docs/getting-started">Getting started</Link><Link href="/docs">Workflows</Link><Link href="/docs">Runs</Link><Link href="/docs">API</Link></nav></div>}
